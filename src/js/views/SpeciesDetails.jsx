...
function SpeciesDetails() {
  let [aux, setaux] = useState("")	
    ...
    let location = useLocation();
      location = location.pathname.split('/species/')
    ...
    const Checker = () => {
      if  (!localStorage.getItem("species")) {
        ...
        setaux(JSON.parse(localStorage.getItem("species"))[location])
      }
    }
    ...
    if (aux == "") {
      ...
      imgUID = actions.getUID(aux, "species")
    }
      ...
      <div className="card mcard bg-dark mb-3">
        <div className="row g-0">
          <div className="col-md-4">
            <img src={"https://starwars-visualguide.com/assets/img/species/"+imgUID+".jpg"} onError={actions.getLoad} className="img-fluid rounded-start" alt="..." />
          </div>
            <div className="card-body col-md-8 d-flex flex-column">
               ...
               Unfortunately the information you were looking for was eaten by an Ewok, our professional team of droids is working on it.
                 ...
                 <ul className="list-group list-group-flush">
                  <li className="lis">Classification: {aux.classification}</li>
                  <li className="lis">Designation: {aux.designation}</li>
                  <li className="lis">Language: {aux.language}</li>
                  <li className="lis">Average Lifespan: {aux.average_lifespan}</li>
                  <li className="lis">Average Height: {aux.average_height}</li>
                </ul>
